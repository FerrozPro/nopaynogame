...
ID_FIDELITY_CARD INT(11) NOT NULL AUTO_INCREMENT,
POINTS INT(11) NOT NULL,

CONSTRAINT FIDELITY_CARD_PK PRIMARY KEY (ID_FIDELITY_CARD),
CONSTRAINT FIDELITY_CARD_CK01 CHECK (POINTS >= 0)
) ENGINE=InnoDB;
...
ID_FIDELITY_CARD INT(11),

CONSTRAINT USERS_PK PRIMARY KEY (ID_USER),

CONSTRAINT USERS_FK01 FOREIGN KEY (COD_ROLE) REFERENCES DOM_ROLE(COD_ROLE),
CONSTRAINT USERS_FK02 FOREIGN KEY (ID_FIDELITY_CARD) REFERENCES FIDELITY_CARD(ID_FIDELITY_CARD)
) ENGINE=InnoDB;
